export default function About() {
  return (
    <div className='space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8'>
      <p>
        Introducing Filetwist, the ultimate multimedia conversion powerhouse
      ...
      <div className='space-y-2'>
        ...
        <p>
          Access FileTwist from any device with an internet connection. Whether
      ...
      <div className='space-y-2'>
        <h2 className='text-xl md:text-2xl font-medium text-muted-foreground'>
          🌟 It's Free, It's Powerful, It's FileTwist:
        </h2>
        <p>
